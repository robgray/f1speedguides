<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="createRaceResult.ascx.cs" Inherits="atomicf1.cms.presentation.controls.createRaceResult" %>
...
<div style="MARGIN-TOP: 20px">    
    ...
    <br />
    Race Time:<asp:RequiredFieldValidator id="RequiredFieldValidator2" ErrorMessage="*" ControlToValidate="LapTime" runat="server">*</asp:RequiredFieldValidator><br />
