...
<xsl:template match="/">
  <xsl:variable name="xboxliveid" select="af1:GetDriver($currentPage/driverId)//driver/name" />
  <div>
  <iframe width="204" scrolling="no" height="140" frameborder="0" src="http://gamercard.xbox.com/{$xboxliveid}.card"></iframe>  
  </div>
</xsl:template>
</xsl:stylesheet>