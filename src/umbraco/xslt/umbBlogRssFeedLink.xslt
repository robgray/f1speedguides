...
<xsl:stylesheet
  ...
  <xsl:template match="/">
    ...
    <!-- xslt file that will output all rss feed links 
        ...
        FE:
        <link href="/news/rss.aspx" rel="alternate" type="application/rss+xml" title="RSS Feed" />
        <link href="/news/commentrss.aspx" rel="alternate" type="application/rss+xml" title="Comments RSS Feed" />
