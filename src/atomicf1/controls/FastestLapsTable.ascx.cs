...
{
    public partial class FastestLapsTable : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var model = _statistician.GetFastestLapsTable();
                ...
                FastestLapsRepeater.DataSource = model;
                FastestLapsRepeater.DataBind();
            }
        }
